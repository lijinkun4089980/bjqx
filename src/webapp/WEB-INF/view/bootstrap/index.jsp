...
<head>
    ...
    <link href="../bootstrap/media/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/style-metro.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/style-responsive.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/default.css" rel="stylesheet" type="text/css" id="style_color"/>
    <link href="../bootstrap/media/css/uniform.default.css" rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="../bootstrap/media/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/daterangepicker.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/fullcalendar.css" rel="stylesheet" type="text/css"/>
    <link href="../bootstrap/media/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="../bootstrap/media/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <!-- END PAGE LEVEL STYLES -->
    <link rel="shortcut icon" href="../bootstrap/media/image/favicon.ico"/>
</head>
<h2>初使页面</h2>
...
<%--<script src="../bootstrap/media/js/jquery-1.10.1.min.js" type="text/javascript"></script>--%>
<script src="../bootstrap/media/js/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
<script src="../bootstrap/media/js/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/bootstrap.min.js" type="text/javascript"></script>
<!--[if lt IE 9]>
<script src="../bootstrap/media/js/excanvas.min.js"></script>
<script src="../bootstrap/media/js/respond.min.js"></script>
<![endif]-->
<script src="../bootstrap/media/js/jquery.slimscroll.min.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.blockui.min.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.cookie.min.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.uniform.min.js" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="../bootstrap/media/js/jquery.vmap.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.vmap.russia.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.vmap.world.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.vmap.europe.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.vmap.germany.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.vmap.usa.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.flot.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.flot.resize.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.pulsate.min.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/date.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/daterangepicker.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.gritter.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/fullcalendar.min.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.easy-pie-chart.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/jquery.sparkline.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="../bootstrap/media/js/app.js" type="text/javascript"></script>
<script src="../bootstrap/media/js/index.js" type="text/javascript"></script>
